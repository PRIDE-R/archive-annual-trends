---
title: "PRIDE Archive Annual Trends - Exploratory Data Analysis"
...
In this case we have up to `r num_tissues` different tissues. Just 
`r num_tissues_frequent` of them have been submitted more than ten times. 
Let's plot them.   
...
We have up to `r num_ptm` different modifications. Just 
`r num_ptm_frequent` of them have been submitted more than ten times. 
Let's plot them.   
...
modification with `r ptm_table_frequent["Carbamidomethyl"]` datasets made public
in 2014.  
...
We have up to `r num_instrument` different instrument names. Just 
`r num_instrument_frequent` of them have been submitted more than ten times. 
Let's plot them.   
